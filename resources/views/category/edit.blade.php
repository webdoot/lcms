...
<form method="post" action="{{route('lcms_category.update', $category->id)}}" >
@csrf @method('put')
<div class="row">	
	<div class="col-md-9">
		<div class="card">
		    ...
		    <div class="card-body"> 
		    	...
		    	<div class="mb-3">
					...
					<textarea class="form-control" name="description" placeholder="Description here...">{{$category->description}}</textarea>
				</div>
			</div>
